...
/**
 * Reads the Entra private key when Microsoft exchanges an authorization code.
 */
 ...
 *
 * @param clientId - The Entra app's client ID.
 * @param tokenEndpoint - The Entra token endpoint URL.
 */
 ...
 *
 * @param accessToken - The delegated access token from Microsoft.
