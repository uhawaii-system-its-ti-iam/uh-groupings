                ...
                <div className='flex flex-wrap'>
                    <div className='w-full pr-4 pl-4 relative'>
                        ...
                        <p className='text-gray-900 mb-2 w-full mt-5 ml-0.5'>
                            Changes made may not take effect immediately. Usually, 3-5 minutes should be anticipated.
                            In extreme cases, a request may take several hours to be fully processed, depending on
                            the number of members and the synchronization destination.
                        </p>
                    </div>
                </div>
                ...
                {isSyncDestModalOpen && (
                    <DynamicModal
                        ...
                        body={`Are you sure you want to ${
                            pendingCheckbox?.synced ? 'disable' : 'enable'
                        } the synchronization destination: ${modalSyncDestContent}?`}
                        buttons={[
                            <button
                                key='confirm'
