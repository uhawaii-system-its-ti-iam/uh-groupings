                ...
                {state.isFormVisible && (
                    <div className="relative">
                        ...
                        {currentDescription.length >= 98 && (
                            <Alert data-testid="description-alert" className="bg-red-100 text-[rgb(114,28,36)] lg:w-max lg:h-[50px] md:w-max md:h-[50px] sm:h-1/2 pt-2 pl-2 pr-2 mb-1 mt-1 border">
