const WhatHappensIfSection = () => {
    const whatHappensIfItems = [
        {
            question: 'I was an owner of just one grouping and ' +
                'someone (me or another owner) deleted my ownership while I was still logged in.',
            answer: 'You will still see the Groupings menu option, ' +
        ...
        {
            question: 'I was an admin and someone (me or another admin) deleted my admin role' +
                ' while I was still logged in.',
            answer: 'You will still see the Admin menu option, ' +
                'but you will get an error message when you click on it.' +
