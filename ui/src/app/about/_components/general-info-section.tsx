const GeneralInfoSection = () => {
    const generalInfoItems = [
        ...
        },
        {
            ...
            answer: (
                <>
                    ...
                    A grouping&apos;s components include the Basis, Include, and
                    Exclude lists.
                </>
            )
        },
        {
            ...
            answer: `A grouping's Exclude overrides automatic and manual membership by explicitly not including anyone
            listed here. It may be empty.`
        },
        {
    ...
    return (
        <div className="container pt-10 pb-10">
            <h2 className="text-center text-xl font-bold text-text-color pb-7">
                GENERAL INFORMATION
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {generalInfoItems.map((generalInfoItem, index) => (
                    <div key={index}>
                        <h3 className="text-text-color text-lg pb-1">
