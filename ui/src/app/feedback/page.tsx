...
const Feedback = async () => {
    ...
    return (
        <div className="container grid sm:grid-cols-12 pt-5 pb-4 md:h-full lg:h-[72.3vh]">
            <div className="col-span-5 pt-5">
                <h1 className="text-center md:text-left text-[2rem] font-bold">
                    Feedback
                </h1>
                <p className="text-center md:text-left text-xl mt-1">
                    Helps us to understand where improvements are needed. Please
                    let us know.
                </p>
            </div>
