...
import GroupingsTableHeaders from '@/components/table/groupingsTable/table-element/GroupingsTableHeaders';
...
import GroupingPath from '@/components/table/groupingsTable/table-element/GroupingPath';
