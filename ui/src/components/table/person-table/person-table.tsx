...
const PersonTable = ({
    ...
    // Create dummy boolean value for "fake" functionality with no table data
    ...
    return (
        <>
            <DynamicModal open={modalOpen} title={modalTitle} description={modalDesc} buttons={modalButtons}>
                {modalBody}
            </DynamicModal>
