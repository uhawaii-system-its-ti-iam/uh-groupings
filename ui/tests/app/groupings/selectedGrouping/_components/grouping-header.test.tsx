...
jest.mock('@/app/groupings/[selectedGrouping]/_components/description-form');
...
describe('GroupingHeader Component', () => {
    ...
    it('should render DescriptionForm', () => {
        ...
        expect(DescriptionForm).toHaveBeenCalledWith(
            { groupDescription: GroupDescription, groupPath: GroupPath },
            {}
        );
    });
});
